		...
		<div class="single-item-carousel owl-carousel owl-theme">
				...
				<div class="auto-container">
					...
					<div class="slider-two-content">
						<div class="slider-two_inner">
							...
							<h1 class="slider-two_heading">Impulsamos el crecimiento de tu empresa con soluciones digitales</h1>
							<div class="slider-two_text">Software a medida, automatización e integraciones con <br>herramientas para escalar, ganar eficiencia y tomar mejores decisiones</div>
							<!-- Button Box -->
			...
			<div class="slide">
				...
				<div class="auto-container">
					...
					<div class="slider-two-content">
						<div class="slider-two_inner">
							<div class="slider-two_title">Marketing y Estrategia</div>
							<h1 class="slider-two_heading">Campaña de adquisición a la medida de tu empresa</h1>
							<div class="slider-two_text">Te ayudamos a alcanzar más clientes y mercados <br> analizando tu alcance actual y utilizando las últimas técnicas de adquisición.</div>
							<!-- Button Box -->
							<div class="slider-two_button-box">
								<a class="btn-style-two theme-btn btn-item" href="#">
									<div class="btn-wrap">
				...
				<div class="about-two_content col-lg-6 col-md-12 col-sm-12">
					<div class="about-two_content-inner">
						...
						<div class="about-two_text">
							En PyMENTO ayudamos a PyMES y STARTUPS a convertir ideas en resultados. Combinamos experiencia en desarrollo, automatización y estrategia 
							digital para mejorar procesos, reducir costos y acelerar ventas. 
							Trabajamos cerca, con foco en objetivos y con acompañamiento real: no entregamos y desaparecemos, nos quedamos para que todo funcione y evolucione.
						</div>
							...
							<div class="row clearfix">
								...
								<div class="about-two_block col-lg-6 col-md-6 col-sm-6">
									<div class="about-two_block-inner">
										...
										<h6 class="about-two_block-heading">Implementación rápida <br> y clara</h6>
									</div>
								</div>
				...
				<div class="four-item-carousel owl-carousel owl-theme">
					...
					<div class="service-block_three">
						<div class="service-block_three-inner">
							...
							<div class="service-block_three-text">
								Campañas, embudos y medición para atraer clientes y convertir mejor.
							</div>
							...
							<div class="service-block_three-overlay">
								...
								<h5 class="service-block_three-heading alternate">
									<a href="service-detail.html#marketing">Marketing y Adquisición</a>
								</h5>
								<a class="service-block_three-learn" href="service-detail.html#marketing">Ver detalle</a>
							</div>
						</div>
					</div>
					...
					<div class="service-block_three">
						<div class="service-block_three-inner">
							...
							<div class="service-block_three-text">
								Diagnóstico, prioridades y plan de acción para ordenar y escalar.
							</div>
							...
							<div class="service-block_three-overlay">
								...
								<h5 class="service-block_three-heading alternate">
									<a href="service-detail.html#consultoria">Consultoría en negocios</a>
								</h5>
								<a class="service-block_three-learn" href="service-detail.html#consultoria">Ver detalle</a>
							</div>
						</div>
					</div>
					...
					<div class="service-block_three">
						<div class="service-block_three-inner">
							...
							<div class="service-block_three-overlay">
								...
								<h5 class="service-block_three-heading alternate">
									<a href="service-detail.html#desarrollo">Desarrollos y soluciones</a>
								</h5>
								<a class="service-block_three-learn" href="service-detail.html#desarrollo">Ver detalle</a>
							</div>
						</div>
					</div>
					...
					<div class="service-block_three">
						<div class="service-block_three-inner">
							...
							<div class="service-block_three-text">
								Asistentes, automatización y respuestas rápidas sin perder calidad.
							</div>
							...
							<div class="service-block_three-overlay">
								...
								<h5 class="service-block_three-heading alternate">
									<a href="service-detail.html#ia">IA aplicada a soporte/ventas</a>
								</h5>
								<a class="service-block_three-learn" href="service-detail.html#ia">Ver detalle</a>
							</div>
						</div>
					</div>
					...
					<div class="service-block_three">
						<div class="service-block_three-inner">
							<span class="service-block_three-icon">
								<img src="<?= $base_url ?>/images/icons/feature-5.png" alt="Content Factory" />
							</span>
							<h5 class="service-block_three-heading">Content Factory</h5>
							<div class="service-block_three-text">
								Acompañamiento real, seguimiento y mejoras continuas post-entrega.
							</div>
							...
							<div class="service-block_three-overlay">
								...
								<h5 class="service-block_three-heading alternate">
									<a href="service-detail.html#atencion">Content Factory</a>
								</h5>
								<a class="service-block_three-learn" href="service-detail.html#atencion">Ver detalle</a>
							</div>
						</div>
					</div>
					...
					<div class="inner-column" style="background-image: url(<?= $base_url ?>/images/background/pattern-26.png)">
						<div class="authors-outer">
							<div class="author-one">
								<img src="<?= $base_url ?>/images/resource/author-2.jpg" alt="" />
							</div>
							<div class="author-two">
								<img src="<?= $base_url ?>/images/resource/author-3.jpg" alt="" />
							</div>
							<div class="author-three">
								<img src="<?= $base_url ?>/images/resource/author-4.jpg" alt="" />
							</div>
							<div class="author-four">
								<img src="<?= $base_url ?>/images/resource/author-5.jpg" alt="" />
							</div>
						</div>
						...
						<div class="single-item-carousel owl-carousel owl-theme">
								...
								<div class="author-box">
									<div class="box-inner">
										<span class="author-image">
											<img src="<?= $base_url ?>/images/resource/author-1.jpg" alt="" />
										</span>
										<h5>Mariana G.</h5>
							...
							<div class="testimonial-block">
								<div class="inner-box">
									...
									<div class="text">“Nos ayudaron con estrategia y ejecución: mejoras en la web, medición y campañas. Lo mejor fue la comunicación: todo claro, prioridades bien definidas y seguimiento constante.”</div>
								</div>
								<div class="author-box">
									<div class="box-inner">
										<span class="author-image">
